        ...
        <div class="offcanvas d-none d-lg-block  offcanvas-end" data-bs-scroll="false" tabindex="-1"
            ...
            <div class="offcanvas-body">
                ...
                <div class="author-about mb-40 ">
                    <div class="text-center">
                        <div class="author-iamge">
                            <a href="author-1"><img src="{{ url('assets/images/placeholder.svg') }}"
                                    data-src="{{ url('assets/images/about-image-1.png') }}" alt="author-iamge"></a>
                        </div>
                ...
                <div class="sidebar-gallery mb-40">
                    <div class="div1 image-hover"><img src="{{ url('assets/images/placeholder.svg') }}"
                            data-src="{{ url('assets/images/instagram/instagram-1.png') }}" alt="instagram">
                    ...
                    <div class="div2 image-hover"><img src="{{ url('assets/images/placeholder.svg') }}"
                            data-src="{{ url('assets/images/instagram/instagram-4.png') }}" alt="instagram">
                        <span class="d-flex justify-content-center mb-10">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="div3 image-hover"><img src="{{ asset('assets/images/placeholder.svg') }}"
                            data-src="{{ url('assets/images/instagram/instagram-7.png') }}" alt="instagram">
                        <span class="d-flex justify-content-center mb-10">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="div4 image-hover"><img src="{{ url('assets/images/placeholder.svg') }}"
                            data-src="{{ url('assets/images/instagram/instagram-3.png') }}" alt="instagram">
                        <span class="d-flex justify-content-center mb-10">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="div5 image-hover"><img src="{{ url('assets/images/placeholder.svg') }}"
                            data-src="{{ url('assets/images/instagram/instagram-8.png') }}" alt="instagram">
                        <span class="d-flex justify-content-center mb-10">
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="offcanvas-header pb-30">
                <a class="navbar-brand dark-light-logo" href="/" aria-label="nav-brands">
                    <img src="{{ url('assets/logo/Jadi Trip Bputih.png') }}"
                        ...
                        alt="jadi trip">
                    <img src="{{ url('assets/logo/Jadi Trip Bhitam.png') }}"
                        data-src="{{ url('assets/logo/Jadi Trip Bhitam.png') }}" class="logo-light gambar-logo"
                        alt="jadi trip">
                </a>
                    ...
                    <div class="row custom-row-gap">
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            ...
                            <div class="mini-card-style mb-lg-40 mb-30">
                                <div class="card-image-wrapper">
                                    <a href="/article"><img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/feature-images/feature-image-1.jpg') }}"
                            ...
                            <div class="mini-card-style mb-lg-40 mb-30">
                                <div class="card-image-wrapper">
                                    <a href="/article"> <img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/feature-images/feature-image-7.jpg') }}"
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            ...
                            <div class="mini-card-style mb-lg-40 mb-30">
                                <div class="card-image-wrapper">
                                    <a href="/article"> <img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/feature-images/feature-image-3.jpg') }}"
                                            class="card-img-top" alt="Stories"> </a>
                                </div>
                            ...
                            <div class="mini-card-style mb-lg-40 mb-30">
                                <div class="card-image-wrapper">
                                    <a href="/article"> <img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/feature-images/feature-image-4.jpg') }}"
                                            class="card-img-top" alt="Stories"> </a>
                                </div>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            ...
                            <div class="mini-card-style mb-lg-40 mb-30">
                                <div class="card-image-wrapper">
                                    <a href="/article"> <img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/feature-images/feature-image-5.jpg') }}"
                                            class="card-img-top" alt="Stories"> </a>
                                </div>
                        ...
                        <nav aria-label="breadcrumb-nav">
                            @if (Request::is('blog'))
                                <ol class="breadcrumb breadcrumb-style-2 mt-20 mb-0 ">
                                    <li class="breadcrumb-item breadcrumb-item-style-2"><a href="/">Home</a>
                                    </li>
                                    <li class="breadcrumb-item breadcrumb-item-style-2"><a href="/blog">blog</a>
                                    </li>
                                </ol>
                            @elseif (Request::is('blog/*'))
                                <ol class="breadcrumb breadcrumb-style-2 mt-20 mb-0 ">
                                    ...
                                    <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">
                        ...
                        <div class="col-xl-4">
                            <div class="sticky-elements">
                                ...
                                <div class="widget widget-style-2 mb-lg-60 mb-0 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div
                                        class="social-icons d-flex flex-wrap justify-content-center align-items-center gap-20">
