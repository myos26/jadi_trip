                        ...
                        <div class="d-none d-xl-block ms-5">
                            <div class="d-flex gap-70 align-items-center">
                                <ul class="gap-20 navbar-nav mb-2 me-2 mb-lg-0">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link nav-link-style-2 d-flex gap-2 align-items-center"
                                            aria-current="page" rel="nofollow" href="{{ url('about') }}" aria-label="nav-links">
                                            About
                                        </a>
                                    </li>
                                    <li class="nav-item dropdown">
                                        <a class="nav-link nav-link-style-2 d-flex gap-2 align-items-center"
                                            aria-current="page" rel="nofollow" href="{{ url('kontak') }}" aria-label="nav-links">
                                            Kontak
                                        </a>
                                    </li>
                                </ul>
                                <div class="d-flex align-items-center gap-20">
                                    <!-- serch-icon -->
                                    <a class="serch-icon-style-2" data-bs-toggle="offcanvas"
                                        ...
                                        <div class="sub-menu-wrap" id="subMenu">
                                            <div class="sub-menu">
                                                ...
                                                <div class="sub-menu-link">
                                                    ...
                                                    <a href="profil" rel="nofollow">Profile</a>
                                                </div>
                                                <div class="sub-menu-link">
                                                    <span class="material-icons-sharp sub-icon">
                                                        account_circle
                                                    </span>
                                                    <a href="dashboard" rel="nofollow">Dashboard</a>
                                                </div>
                ...
                <div class="container">
                    <nav aria-label="breadcrumb-nav">
                        <ol class="breadcrumb breadcrumb-style-2 mt-20 mb-0 ">
                            ...
                            <li class="breadcrumb-item breadcrumb-item-style-2 active" aria-current="page">Contact
                            </li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-xl-8  col-lg-8">
                            <div class="contact-page-content">
                                ...
                                <p class="mb-30 fix-width-post-content">I'm always excited to connect with fellow
                                    travel enthusiasts, readers, and potential collaborators. Whether you have questions
                                    about a destination, want travel tips, or simply wish to share your own adventures,
                                    I'd love to hear from you.</p>

                                <p class="mb-60 fix-width-post-content">Drop me a message below, and let's embark on a
                                    conversation filled with wanderlust and travel tales!</p>
                                ...
                                <div class="contact-from-area fix-width-post-content">
                                    ...
                                    <form id="contactForm" class="contact-from">
                                        ...
                                        <button type="submit"
                                            class="btn btn-primary mb-lg-0 mb-20 mt-lg-40 mt-10">Submit Form</button>
                                    </form>
                                </div>
                                ...
                                <div class="author-card author-card-sidebar-style-2  flex-column mb-30">
                                    ...
                                    <div class="author-image m-auto">
                                        <img src="assets/images/placeholder.svg"
                                            data-src="assets/images/about-image-1.png" alt="author-image">
                                    </div>
                                    ...
                                    <div class="author-information-area">
                                        ...
                                        <div class="single-info"><span class="information-icon"><img
                                                    src="assets/images/placeholder.svg"
                                                    data-src="assets/images/phone.png" alt="phone"></span>
                                            <a href="tel:+14842989691" rel="nofollow">+14842989691</a>
                                        </div>
                                        <div class="single-info">
                                            <span class="information-icon"><img src="assets/images/placeholder.svg"
                                                    data-src="assets/images/mail.png" alt="phone"></span>
                                            <a href="mailto:contact@Jadi Trip.com" rel="nofollow">contact@Jadi Trip.com</a>
                                        </div>
                                        <div class="single-info">
                                            <span class="information-icon"><img src="assets/images/placeholder.svg"
                                                    data-src="assets/images/location.png" alt="phone"></span>
                                            <address class="text-start">132, My Street, Kingston,New York 12401.
                                            </address>
                                        </div>
                                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="add-banner">
                                <a href="#" rel="nofollow"><img src="assets/images/add-02.png" alt="add-image" class="border-rarius-14"></a>
                            </div>
                        </div>
                    </div>
                </div>
