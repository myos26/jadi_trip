                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                    ...
                                    <div class="card-body">
                                        <div class="card-header text-uppercase">
                                            <a href="{{ url('paket', ['kategori' => $paket->kategori]) }}"
                                                rel="nofollow">{{ $paket->kategori }}</a>
                                        </div>
                                        <h5 class="fs-4 card-title"><a
                                                href="{{ url('paket/' . $paket->tipe . '/' . $paket->slug) }}"
                                                rel="nofolow" class="blog-title">{{ $paket->title }}</a></h5>
                                        <ul class="list-unstyled card-meta lead  small">
                                            <li>By <a href="{{ url('about') }}" rel="bofollow"
                                                    class="blog-author fw-bold">Jadi Trip</a></li>
