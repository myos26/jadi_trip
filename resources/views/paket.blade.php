                                    ...
                                    <div class="d-flex gap-20 align-items-center">
                                        ...
                                        @if (Auth::check())
                                            <div class="box-profile" style="width: 40px; height: 40px; overflow: hidden;">
                                                <img width="40" src="{{ url('admin/images/' . Auth::user()->photo) }}"
                                        ...
                                        @if (!Auth::check())
                                            ...
                                            <div class="box-profile" style="width: 40px; height: 40px; overflow: hidden;">
                                                <img width="40" src="{{ url('admin/images/noimage.webp') }}" class="user_pic"
                        ...
                        <div class="row custom-row-gap">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                        <a href="article"><img src="{{ url('assets/images/placeholder.svg') }}" data-src="{{ url('assets/images/blog/explore-image-35.jpg') }}" class="card-img-top" alt="img-top"></a>
                                    </div>
