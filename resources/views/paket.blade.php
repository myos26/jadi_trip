                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                ...
                                @if(Request::is('paket/*')) <!-- Memeriksa apakah Anda berada di '/paket/{kategori}' -->
                                    <h2 class="text-white">{{ $kategori }}</h2>
                                    <p class="text-white">{{ $paketCount }} paket tersedia</p>
                                @else <!-- Jika Anda berada di '/paket' -->
            ...
            <section class="section-blog py-4 py-sm-5 py-md-60 py-lg-100">
                <div class="container">
                    <div class="row custom-row-gap">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                data-wow-delay="0.4s">
                                <div class="card-image-wrapper">
                                    <a href="{{ url('paket/'.$paket->tipe.'/'.$paket->slug) }}" rel="nofollow">
                                ...
                                <div class="card-body">
                                    <div class="card-header text-uppercase">
                                        <a href="{{ url('paket', ['kategori' => $paket->kategori]) }}" rel="nofollow">{{ $paket->kategori }}</a>
                                    </div>
                                    <h5 class="fs-4 card-title"><a href="{{ url('paket/'.$paket->tipe.'/'.$paket->slug) }}" rel="nofolow" class="blog-title">{{ $paket->title }}</a></h5>
                                    <ul class="list-unstyled card-meta lead  small">
                                        <li>By <a href="{{ url('about') }}" rel="bofollow" class="blog-author fw-bold">Jadi Trip</a></li>
                                        <li>{{ \Carbon\Carbon::parse($paket->created_at)->format('F d, Y') }}</li>
                                    </ul>

                                    <p class="card-text small">{{ $paket->deskripsi }}</p>
                    ...
                    <div class="load-more-btn pt-20 wow fadeInUp" data-wow-delay="0.4s">
                        <a href="{{ url('paket') }}" class="btn btn-secondary">Load More</a>
                    </div>
