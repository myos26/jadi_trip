                            ...
                            <div class="d-none d-xl-block ms-5">
                                <div class="d-flex gap-70 align-items-center">
                                    <ul class="gap-20 navbar-nav mb-2 me-2 mb-lg-0">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link active nav-link-style-2 d-flex gap-2 align-items-center" aria-current="page" href="blog.html" aria-label="nav-links" data-bs-toggle="dropdown" aria-expanded="false">
                                                Paket
                                                <span class="dropdown-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
                                                    <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
                    ...
                    <div class="author-about mb-40 ">
                        <div class="text-center">
                            <div class="author-iamge">
                                <a href="about.html"><img src="assets/images/placeholder.svg" data-src="assets/images/about-image-1.png" alt="author-iamge"></a>
                            </div>
                            <h5><a  class="author-name" href="about.html">Mike Aiden</a></h5>
            ...
            <div class="offcanvas offcanvas-end offcanvasmobile-menu" id="offcanvasmobile-menu" data-bs-backdrop="static" tabindex="-1">
                ...
                <div class="offcanvas-body d-flex justify-content-start"> 
                    <ul class="navbar-nav custom-navbar-nav mb-2  mb-lg-0 hover-menu">
                        <li class="nav-item dropdown">
                            <a class="nav-link d-flex gap-2 align-items-center" aria-current="page" href="blog.html" aria-label="nav-links">
                                Destinasi
                            </a>									
                        </li>
                        <li class="nav-item dropdown">
                                ...
                                <div class="sticky-elements">
                                    ...
                                    <div class="sidebar-style d-none d-xl-block">
                                        <div class="author-details mb-lg-60 mb-40">
                                            ...
                                            <h6 class="text-end" ><a href="about.html" class="author-name">Mike Aiden</a></h6>
                                ...
                                <div class="sticky-elements">
                                    <div class="d-flex flex-column gap-lg-60 gap-30"> 
                                        ...
                                        <div class="catagory">
                                            ...
                                            <div class="catagory-tag">
                                                <a href="category.html">HIKING <span class="catagory-count">10</span></a>
                                                <a href="category.html">CAMPING <span class="catagory-count">20</span></a>
                                            <a href="category.html">FOREST <span class="catagory-count">18</span></a>
                                                <a href="category.html">DESERT <span class="catagory-count">14</span></a>
                                                <a href="category.html">MARINE <span class="catagory-count">45</span></a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card card-style-10 card-border">
                                                    <div class="d-flex align-items-center gap-lg-20 gap-10 ">
                                                        ...
                                                        <div class="card-body p-0  mt-auto">
                                                            <h5 class="card-title lead fw-extrabold"><a href="about.html" class="blog-title">Quick and Easy Flaky  Pastry for Tasty Breakfast</a></h5>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="card card-style-10 card-border">
                                                    <div class="d-flex align-items-center gap-lg-20 gap-10 ">
                                                        ...
                                                        <div class="card-body p-0  mt-auto">
                                                            <h5 class="card-title lead fw-extrabold"><a href="article.html" class="blog-title">Quick and Easy Flaky  Pastry for Tasty Breakfast</a></h5>
                                                        </div>
                                                    </div>                                                                                         
                                                </div>
                                                <!-- card card-style-10 -->
                        ...
                        <div class="row custom-row-gap">
                            <div class="col-lg-4">
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                        <a href="article.html"><img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-21.jpg" class="card-img-top" alt="Lake"></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="list-unstyled card-meta lead  small">
                                            <li>By <a href="about.html" class="blog-author fw-bold">Mike Aiden</a></li>
                                            <li>January 27, <span class="dynamic-year"> </span>.</li>
                                        </ul>
                            ...
                            <div class="col-lg-4">
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                       <a href="blog.html"> <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-30.jpg" class="card-img-top" alt="Forest"></a>
                                    </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                       <a href="blog.html"> <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-47.jpg" class="card-img-top" alt="img-top"></a>
                                    </div>
