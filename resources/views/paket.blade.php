...
<body>
                                ...
                                <div class="d-flex gap-20 align-items-center">
                                    ...
                                    @if (Auth::check())
                                        <div class="box-profile" style="width: 40px; height: 40px; overflow: hidden;">
                                            <img width="40"
                                                src="{{ url('admin/images/' . Auth::user()->photo) }}"
                                        ...
                                        <div class="sub-menu-wrap" id="subMenu">
                                            <div class="sub-menu">
                                                <div class="user-info">
                                                    ...
                                                    <img src="{{ url('admin/images/' . Auth::user()->photo) }}">
                                    ...
                                    @if (!Auth::check())
                                        ...
                                        <div class="box-profile" style="width: 40px; height: 40px; overflow: hidden;">
                                            <img width="40" src="{{ url('admin/images/noimage.webp') }}"
                ...
                <div class="author-about mb-40 ">
                    <div class="text-center">
                        <div class="author-iamge">
                            <a href="author-1"><img src="assets/images/placeholder.svg"
                    ...
                    <div class="container">
                        <nav aria-label="breadcrumb ">
                            <ol class="breadcrumb mb-100">
                                ...
                                <li class="breadcrumb-item breadcrumb-style-3 active" aria-current="page">Category
                                </li>
                            </ol>
                        </nav>
                        <!-- breadcrumb -->
                    ...
                    <div class="row custom-row-gap">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                data-wow-delay="0.4s">
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="{{ url('assets/images/placeholder.svg') }}"
                                            data-src="{{ url('assets/images/blog/explore-image-35.jpg') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Mountain Magic:
                                            A Hiker's Guide to Scenic Views</a></h5>
                                    ...
                                    <p class="card-text small">Embark on a journey of awe and wonder with 'Mountain
                                        Magic: A Hiker's Guide to Scenic Views.' This captivating guidebook unveils the
                                        secrets of...</p>
                                    <div class="clickHere">
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-36.jpg" class="card-img-top"
                                            alt="Hiking"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Hike, Explore,
                                            Thrive: Your Guide to Outdoor Adventure</a></h5>
                                    ...
                                    <p class="card-text small">Hike, Explore, Thrive: Your Guide to Outdoor Adventure"
                                        is an immersive journey into nature's wonders. Uncover hidden trails, embrace
                                        challenges...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-26.jpg" class="card-img-top"
                                            alt="every"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="#" class="blog-title">Trail Tales:
                                            Adventures in Every Step</a></h5>

                                    <ul class="list-unstyled card-meta lead  small">
                                        <li>By <span class="fw-bold"><a href="#" class="blog-author">Atz
                                                    Aiden</a></span></li>
                                        <li>January 25, <span class="dynamic-year"> </span>.</li>
                                    </ul>

                                    <p class="card-text small">Adventures in Every Step" is an exhilarating journey
                                        through the wilderness, weaving captivating stories of exploration and
                                        self-discovery. With each...</p>
                                </div>
                            </div>
                        </div>
                        <!-- single card -->
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-38.jpg" class="card-img-top"
                                            alt="Masterpiece"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Boot Prints:
                                            Leaving Trails in Nature's Masterpiece</a></h5>
                                    ...
                                    <p class="card-text small">Trails in Nature's Masterpiece captures the essence of
                                        our connection to the natural world, highlighting the impact of human presence
                                        through-provoking...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                data-wow-delay="0.4s">
                                <div class="card-image-wrapper">
                                    <a href="blog"> <img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-39.jpg" class="card-img-top"
                                            alt="img-top"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Hike Highs:
                                            Elevate Your Spirit with Nature</a></h5>

                                    <ul class="list-unstyled card-meta lead  small">
                                        <li>By <span class="fw-bold"><a href="#" class="blog-author">Ali
                                                    Aiden</a></span></li>
                                        <li>January 22, <span class="dynamic-year"> </span>.</li>
                                    </ul>

                                    <p class="card-text small">Your Spirit with Nature invites you on a transformative
                                        journey through scenic landscapes. Immerse yourself in the beauty of the great
                                        outdoors and...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-40.jpg" class="card-img-top"
                                            alt="img-top"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Into the
                                            Wilderness: Hiking for Mind, Body, and Soul</a></h5>
                                    ...
                                    <p class="card-text small">Embark transformative journey with Into the Wilderness:
                                        Hiking for Mind and Soul. This captivating exploration not only invigorates your
                                        body but also...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-41.jpg" class="card-img-top"
                                            alt="Tales"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Alpine Odyssey:
                                            Epic Hiking Journeys and Trail Tales</a></h5>
                                    ...
                                    <p class="card-text small">Epic Hiking Journeys and Trail Tales invites readers to
                                        traverse breathtaking landscapes, weaving personal narratives with the allure of
                                        alpine...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <a href="blog">
                                    <div class="card-image-wrapper">
                                        <img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-42.jpg" class="card-img-top"
                                            alt="img-top">
                                    </div>
                                </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Step by Step:
                                            Mastering the Art of Hiking</a></h5>
                                    ...
                                    <p class="card-text small">Mastering the Art of Hiking is essential guide for
                                        outdoor enthusiasts, offering concise yet comprehensive insights on trail, gear
                                        essentials...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-37.jpg" class="card-img-top"
                                            alt="Expert"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Summit Seeker:
                                            Conquer Peaks with Expert Hiking Tips</a></h5>
                                    ...
                                    <p class="card-text small">Expert Hiking Tips'' is an indispensable guide,
                                        navigating adventurers through challenging terrains with seasoned advice.
                                        Elevate your hiking prowess...</p>
                                </div>
                            </div>
                        </div>
                        <!-- single card -->
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-44.jpg" class="card-img-top"
                                            alt="Techniques"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Hike Like a Pro:
                                            Essential Skills and Techniques</a></h5>
                                    ...
                                    <p class="card-text small">Essential Skills and Techniques" is a comprehensive
                                        guide that equips outdoor enthusiasts with vital hiking skills. From navigation
                                        strategies to survival...</p>
                                </div>
                            </div>
                        </div>
                        <!-- single card -->
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-45.jpg" class="card-img-top"
                                            alt="img-top"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Footprints in
                                            Paradise: Hiking Stories and Advice</a></h5>
                                    ...
                                    <p class="card-text small">Hiking Stories and Advice" invites readers on a breath
                                        taking journey through nature's wonders. This captivating book combines vivid
                                        hiking tales with...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp"
                                ...
                                <div class="card-image-wrapper">
                                    <a href="article"><img src="assets/images/placeholder.svg"
                                            data-src="assets/images/blog/explore-image-16.jpg" class="card-img-top"
                                            alt="Hiking-Gems"></a>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="fs-4 card-title"><a href="article" class="blog-title">Trail Treasure:
                                            Unveiling Nature's Hidden Hiking Gems</a></h5>
                                    ...
                                    <p class="card-text small">Embark on a journey of discovery with "Trail Treasure,"
                                        where each step reveals nature's hidden gems. This hiking experience unveils the
                                        enchanting...</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-center gap-10">
                                ...
                                <a class="footer-logo" href="/" aria-label="nav-brands">
                                    <img src="assets/images/placeholder.svg" data-src="assets/images/logo-primary.png"
    ...
    <script src="{{ url('assets/js/gsap/SplitText.min.js') }}"></script>
    <script src="{{ url('assets/js/gsap/ScrollTrigger.min.js') }}"></script>
    <script src="{{ url('assets/js/gsap/split-type-0.3.3.min.js') }}"></script>
